...
const (
	...
	AuthorizationUnavailable Code = 50004
	PermissionPolicyMissing  Code = 50005
)
...
func (c Code) Valid() bool {
	...
	case OK, InvalidArgument, NotFound, RequestTimeout, TooManyRequests,
		...
		LockUnavailable, Internal, DependencyUnavailable, AuthorizationUnavailable,
		PermissionPolicyMissing:
		return true
	default:
		return false
	}
